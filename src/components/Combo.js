                ...
                <div className="mt-5 combo-main-div container-fluid">
                    <div className=" container" >
                                ...
                                <div className="row">
                                    <div className="mt-3 text-center col-md-3  col-12">
                                        ...
                                        <ul className="d-flex text-center  p-0 pricinglist">
                                            ...
                                            <li className="mt-3 text-left"><MDBIcon icon="check" className="px-2" />3 Dedicated Designer
                                                <li className="text-left mt-3"><MDBIcon icon="check" className="px-2" />3 Dedicated Designer
                                                </li>
                                            </li>
                                            <li className="text-left mt-3"><MDBIcon icon="check" className="px-2" />3 Dedicated Designer
                                            </li>
                                    ...
                                    <div className="last-div p-0  col-md-3 col-12">
                                        <h1 className="mt-5 pt-2 text-center combo-heading-2">$955.00</h1>
                                        <div className="mt-4 text-center">
                                            <button className="  btn-1 ">75% OFF <del >$3820.00</del></button>
                                        </div>
                                        <div className="text-center mt-4  mt-3 px-4">
                                            <span className="last-div-span">Click Here to <MDBIcon icon="sms" className="sms px-2" size="lg" /></span>
                        ...
                        <div className=" text-center">
                            <button className=" my-5 combo-last-btn ">View Combo Packages</button>
                        </div>
                    </div>
                </div>
            </div>
